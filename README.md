...
1. **Clone the repository**
   ...
   ```bash
   git clone https://github.com/omipheo/portfolio.git
   cd portfolio
   ```
...
Contributions, issues, and feature requests are welcome! Feel free to check the [issues page](https://github.com/omipheo/portfolio/issues).

## 👨‍💻 Author

**Serhii Vorobiov**

- Portfolio: [https://svorobiov.dev](https://svorobiov.dev)
- GitHub: [@lightify97](https://github.com/omipheo)
- LinkedIn: [LinkedIn](https://www.linkedin.com/in/serhii-vorobiov-95b298390/)
- Email: omipheo@gmail.com
