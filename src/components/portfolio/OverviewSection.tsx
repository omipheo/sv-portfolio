                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    <div className="p-2 md:p-3 bg-blue-500 rounded-lg md:rounded-xl shadow-lg">
                      <Icon icon="simple-icons:wix" className="text-white w-5 md:w-6 h-5 md:h-6" width={24} height={24} />
                    </div>
                    <div>
                      <h4 className="font-bold text-gray-900 dark:text-white text-base md:text-lg">Junior Software Developer</h4>
                      {/* <p className="text-blue-600 dark:text-blue-400 font-medium text-sm md:text-base">Upwork Freelancer</p> */}
                      <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">2024 — 2025</p>
                    </div>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
                    Built responsive and user-friendly web interfaces using HTML, CSS, JavaScript, and React, collaborating with designers and developers to enhance user experience and maintain clean, efficient code.
                  </p>
                ...
                >
                  <div className="flex items-start gap-3 md:gap-4 mb-3 md:mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs md:text-sm text-gray-600 dark:text-gray-400 mt-1">2023 — 2023</p>
                    </div>
                  </div>
                  <p className="text-gray-700 dark:text-gray-300 text-xs md:text-sm leading-relaxed mb-2 md:mb-3 flex-1">
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-purple-50/90 to-pink-50/90 dark:from-purple-950/30 dark:to-pink-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3">
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white break-all">omipheo@gmail.com</div>
                  </div>
                </motion.a>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">svorobiov.dev</div>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    <div className="text-sm font-bold text-gray-900 dark:text-white">Kyiv, Ukraine</div>
                  </div>
                </motion.div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl bg-gradient-to-br from-emerald-50/90 to-cyan-50/90 dark:from-emerald-950/30 dark:to-cyan-950/30 backdrop-blur-sm border border-white/30 dark:border-gray-700/40 shadow-xl">
              ...
              <div className="space-y-3.5">
                ...
                >
                  ...
                  <span className="text-sm font-medium text-gray-800 dark:text-gray-300">Remote</span>
                </motion.div>
              </div>
            </div>
          </motion.div>
